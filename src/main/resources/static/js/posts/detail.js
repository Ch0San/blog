/*
 * posts/detail.js
 * - 게시글 좋아요 토글, 댓글 좋아요 토글
 * - 댓글 수정 폼 토글, URL 복사, SNS 공유
 */
    ...
    likeBtn.addEventListener('click', async function () {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (likeBtnText) likeBtnText.textContent = data.isLiked ? '좋아요 취소' : '좋아요';
    ...
    btn.addEventListener('click', async function () {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (likeText) likeText.textContent = data.isLiked ? '좋아요 취소' : '좋아요';
          this.setAttribute('data-is-liked', data.isLiked);
        }
      } catch (error) {
...
function copyCurrentUrl() {
  ...
  navigator.clipboard
    ...
    .catch(() => {
      prompt('복사에 실패했습니다. 아래 URL을 복사해주세요', url);
    });
}
...
function copyCurrentUrl() {
  ...
  navigator.clipboard
    ...
    .catch(() => {
      prompt('복사에 실패했습니다. 아래 URL을 복사해 주세요', url);
    });
}
