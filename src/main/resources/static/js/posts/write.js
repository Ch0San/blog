  ...
  return function(align) {
    ...
    if (img) {
      try {
        ...
        // Apply float-based alignment so text can wrap next to image
        ...
        // Move caret to after wrapper and ensure typing area exists so multiple lines wrap next to the float
