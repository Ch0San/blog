...
('할로윈 호박 장식 만들기', '할로윈을 맞아 호박으로 멋진 장식을 만드는 과정을 담았습니다. 초보자도 쉽게 따라할 수 있는 가이드입니다.', 'admin', '/uploads/videos/test_haloween_punkin.mp4', '브이로그', '할로윈,DIY,장식', 289, 45, true, NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY),
